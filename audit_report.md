# Codex Developer v12.3 — Complete Inventory Report
...
| # | Path | Language | Purpose | Dependencies |
|---|------|----------|---------|--------------|
| 70 | `listen.sh.bak.v12.2_pre_awareness` | Bash | Pre-v12.2 backup | None |
...
| # | File | Severity | Notes |
|---|------|----------|-------|
| 1 | `listen.sh` | [WARNING] | Has version header (`# CODES-DEVELOPER v12.3`) but no DNA fingerprint |
